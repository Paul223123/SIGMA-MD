...
global.owner = process.env.OWNER_NUMBER  || '2347026961677' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"AKIRA",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '04_07_2024_SIGMA_MD_DAjqeuZG_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'AKIRA',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `PAUL KIYOTAKA`, // ADD YOUR NAME
